...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / '0', help='file/dir/URL/glob, 0 for webcam')  # source: 测试数据文件(图片或视频)的保存路径 默认data/images
    ...
    parser.add_argument('--view-img', action='store_true', default=False, help='show results')  # view-img: 是否展示预测之后的图片或视频 默认False
